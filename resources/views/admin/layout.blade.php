...
{{--                                        <a href="#">--}}
{{--                                            <i class="far fa-users text-aqua"></i> 5 new members joined today--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <!-- end notification -->--}}
{{--                                </ul>--}}
...
{{--                    </li>--}}
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    <small>{{ auth()->user()->created_at->locale('es')->translatedFormat('l d \d\e F \ \d\e\l\ Y')  }}</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ route('admin.users.show', auth()->user()) }}" class="btn btn-info btn-flat">Perfil</a>
                                </div>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020 <a href="#">Fabian A. Gallardo</a>.</strong> Todos los derechos reservados.
    </footer>
